                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                ...
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    <!-- Cart Area -->
                                    <div class="cart">
                                        <a href="#" id="header-cart-btn" target="_blank"><span class="cart_quantity">2</span> <i class="ti-bag"></i> Votre Panier</a>
...
<br><br>
                    ...
                    <div class="row h-100">
                        <div class="col-12 d-md-flex justify-content-between">
                            ...
                            <div class="header-social-area">
                                <a href="#"><span class="karl-level">Partager</span> <i class="fa fa-pinterest" aria-hidden="true"></i></a>
                                ...
                                <nav class="navbar navbar-expand-lg align-items-start">
                                    ...
                                    <div class="collapse navbar-collapse align-items-start collapse" id="karl-navbar">
                                        <ul class="navbar-nav animated" id="nav">
                                            ...
                                            {{-- <li class="nav-item"><a class="nav-link" href="#">Tenues d'apparat</a></li> --}}
                                            <li class="nav-item"><a class="nav-link" href="#"><span class="karl-level">Exclusivité</span> Accéssoires</a></li>
                                            <li class="nav-item"><a class="nav-link" href="/cosmetic"><span class="karl-level">BIENTOT</span>Cosmétiques</a></li>
                                            <li class="nav-item"><a class="nav-link" href="/electronic"><span class="karl-level">BIENTOT</span>Electronique</a></li>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
                            <!-- Help Line -->
                            <div class="help-line">
                                <a href="tel:+237650155100"><i class="ti-headphone-alt"></i> +237 650 155 100</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="top-discount-area d-md-flex align-items-center">
            ...
            <div class="single-discount-area">
                <h5>Livraisons &amp; Retour Gratuit</h5>
                <h6><a href="#">Acheter Maintenant</a></h6>
            </div>
            <!-- Single Discount Area -->
            <div class="single-discount-area">
                <h5>20% de remise sur les accéssoires</h5>
                <h6>USE CODE: IRISACC</h6>
            </div>
            <!-- Single Discount Area -->
            <div class="single-discount-area">
                <h5>11% de remise sur les cosmétiques 100% CMR</h5>
                        ...
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h6 data-animation="bounceInDown" data-delay="0" data-duration="500ms">* Des produits d'une rareté ....</h6>
                                    <h2 data-animation="fadeInUp" data-delay="500ms" data-duration="500ms">sapper ? Notre affaire</h2>
                                    <a href="#" class="btn karl-btn" data-animation="fadeInUp" data-delay="1s" data-duration="500ms">parcourir</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(img/bg-img/bg-4.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h6 data-animation="fadeInDown" data-delay="0" data-duration="500ms">* La mort de la Tchombé</h6>
                                    <h2 data-animation="fadeInUp" data-delay="500ms" data-duration="500ms">Le goût de ça</h2>
                                    <a href="#" class="btn karl-btn" data-animation="fadeInLeftBig" data-delay="1s" data-duration="500ms">parcourir</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(img/bg-img/bg-2.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                                    <h6 data-animation="fadeInDown" data-delay="0" data-duration="500ms">* Des cadeaux pour les hommes qui valorisent</h6>
                                    <h2 data-animation="bounceInDown" data-delay="500ms" data-duration="500ms">Tout pour les dames</h2>
                                    <a href="#" class="btn karl-btn" data-animation="fadeInRightBig" data-delay="1s" data-duration="500ms">parcourir</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="new_arrivals_area section_padding_100_0 clearfix">
            ...
            <div class="karl-projects-menu mb-100">
                <div class="text-center portfolio-menu">
                    ...
                    <button class="btn" data-filter=".women">Femmes</button>
                    <button class="btn" data-filter=".man">Hommes</button>
                    <button class="btn" data-filter=".access">ACCESSOiRES</button>
                    <button class="btn" data-filter=".shoes">Chausures</button>
                    <button class="btn" data-filter=".kids">Enfants</button>
                </div>
            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Conçu avec <i class="fa fa-heart-o" aria-hidden="true"></i> par <a href="https://www.karismaconcepts.com" target="_blank">Karisma Concepts</a>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_footer_area">
                            <div class="footer_heading mb-30">
                                <h6>Souscrire à la newsletter</h6>
                            </div>
                            <div class="subscribtion_form">
                                <form action="#" method="post">
                                    <input type="email" name="mail" class="mail" placeholder="Votre email ici">
